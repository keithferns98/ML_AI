...
from multidoc_chat.utils.config_loader import load_config
...
class ApiKeyManager:
        ...
        for key in self.REQUIRED_KEYS:
            if not self.api_keys.get(key):
                ...
                if env_val:
                    ...
                    log.info("Loaded {key} from individual env val")
    ...
    def get(self, key: str)-> str:
        ...
        if not val:
            raise KeyError({"API key for {key} is missing"})
        return val
...
class ModelLoader:
    ...
    def load_embeddings(self):
        ...
        try:
            ...
            log.info("Loading embedding model", error = str(e))
